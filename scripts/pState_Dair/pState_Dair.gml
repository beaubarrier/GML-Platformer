// Script assets// Script assets have changed for v2.3.0 see
// https://help.yoyogames.com/hc/en-us/articles/360005277377 for more information
function pState_Dair(){
	...
	//ProcessAttack(sAtk_Slash, secondArgument) Will be used for a combo attack.
		...
		if (dir = 180 && sprite_index != MewtwoDair) {
			image_xscale = -1;
			sprite_index = MewtwoDair;
			//mask_index = sAtk_Slash
			//ProcessAttack(sAtk_Slash)
			ds_list_clear(hitByAtk);
		}
		if (dir = 0 && sprite_index != MewtwoDair) {
			image_xscale = 1;
			sprite_index = MewtwoDair;
			//mask_index = sAtk_Slash
			//ProcessAttack(sAtk_Slash)
